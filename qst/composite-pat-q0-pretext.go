...
var q1Pretext = []string{
	...
	"   <p>In <b>Entscheidung 1</b> wird Stiftung A von zwei Personen (%v) am besten eingestuft und von drei weiteren mittel. Stiftung B wird von drei Personen am besten eingestuft und von zweien am schlechtesten, und so weiter.</p>",
	...
	// "<p>In <b>Entscheidung 1</b> wird Stiftung A von zwei Personen (%v) mittel    eingestuft und von drei weiteren am schlechtesten. Stiftung B wird von drei Personen am besten eingestuft und von zweien am schlechtesten, und so weiter.</p>",
	"   <p>In <b>Entscheidung 1</b> wird Stiftung A von zwei Personen (%v) am besten eingestuft und von drei weiteren am schlechtesten. Stiftung B wird von drei Personen am besten eingestuft und von zweien am schlechtesten, und so weiter</p>",
}
