...
## Prepare app dir
    ...
    sudo chown gcuser:gcuser /opt/go-questionaire
...
to your application directory:
    ...
    sudo chown -R gcuser:gcuser /opt/go-questionaire/*
...
## Prepare log file 
     ...
     sudo chown gcuser:gcuser /var/log/go-questionaire.log
...
##  Prepare pid file 
     ...
     sudo chown gcuser:gcuser /var/run/go-questionaire/

     sudo touch       /var/run/go-questionaire/prog.pid
     sudo chown gcuser:gcuser /var/run/go-questionaire/prog.pid
