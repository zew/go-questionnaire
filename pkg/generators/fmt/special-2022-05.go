...
var inflationFactorNames2205 = []string{
	...
	"war_ukraine",      // Krieg gegen Ukraine,
	// "other",        // other
}

var inflationFactorLabel2205 = []trl.S{
	{
...
func special202205(q *qst.QuestionnaireT) error {
	...
	// special page 1
	{
...

		{
			...
			for _, v := range inflationFactorNames2205 {
